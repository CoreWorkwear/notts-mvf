...
import { IconWhosIn, IconPlayers, IconOpponents, IconSeasons, IconMedia } from '../components/Icons'
...
const TOOLS = [
  ...
  { to: '/players',   label: 'Players',   blurb: 'Squad records, roles, XL eligibility, subs',     Icon: IconPlayers },
